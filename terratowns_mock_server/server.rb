...
# by setting a global variable. You would never use a global variable in 
# a production server
$home = {}
...
class TerraTownsMockServer < Sinatra::Base
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # a begin/rescue is a try/catch, if an error occurs, resolve it.
    begin
    ...
    # will mock save our data to our mock databse
  ...
  delete '/api/u/:user_uuid/homes/:uuid' do
    ...
    $home = {}
    #{ uuid: uuid }.to_json
    { message: "House deleted successfully", uuid: uuid }.to_json
  end
end
